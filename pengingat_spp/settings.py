"""
Django settings for pengingat_spp project.
...
SECRET_KEY = 'django-insecure-pv-nd_)2rpv4&t^6p_f-ladg8hzqwa^im+n$cf%#4!66r93df2'
...
ROOT_URLCONF = 'pengingat_spp.urls'
...
WSGI_APPLICATION = 'pengingat_spp.wsgi.application'
